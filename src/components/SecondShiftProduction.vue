  ...
  <div>
    <fieldset class="box">
      ...
      <!-- <select v-model="ChosenTeamMember">
        ...
        <option v-for="teamMember in ScndShftPrdctnTmMmbrs" v-bind:value="teamMember.teamMemberID" v-bind:key="teamMember.teamMemberID" v-bind:class="{ 'noScore': (teamMember.scoreStatusID == noScore), 'scoreSaved': (teamMember.scoreStatusID == scoreSaved), 'scoreSubmitted': (teamMember.scoreStatusID == scoreSubmitted), 'teamMemberAbsent': (teamMember.scoreStatusID == teamMemberAbsent) }">{{ teamMember.firstName }} {{ teamMember.lastName }}</option>
      </select> -->
      <!-- <span v-for="teamMember in ScndShftPrdctnTmMmbrs" v-bind:key="teamMember.fullName">
      ...
      <ul class="radio-to-button">
        <li v-for="teamMember in ScndShftPrdctnTmMmbrs" v-bind:key="teamMember.fullName">
          <input v-model="ChosenTeamMember" type="radio" name="teamMember"  v-bind:id="teamMember.teamMemberID" v-bind:value="teamMember"  v-bind:key="teamMember.teamMemberID" v-on:change="getMasterScoreId()">
...
export default {
  ...
  computed: {
    ...
    ScndShftPrdctnTmMmbrs: {
      get () {
        return this.$store.state.ScndShftPrdctnTmMmbrs
      }
    }
  },
  methods: {

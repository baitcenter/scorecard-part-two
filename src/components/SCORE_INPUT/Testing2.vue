      ...
      .then(data => {        
        ...
        var getScoresByMasterScoreIdLoop = function (scores) {
          ...
          for (let score of scores) {
            ...
            promiseArray.push([]);
            // console.log(score);
            for (let promiseFunctionIndex = 0; promiseFunctionIndex <= 15; promiseFunctionIndex++) {
              ...
              switch (promiseFunctionIndex) {
                ...
                case 9:
                  ...
                  promiseArray[displayRowCount][promiseFunctionIndex] = score.scoreTeamMemberID;

                break;
                case 10:
                  // console.log('Case 8: ' + score.scoreID);

                  promiseArray[displayRowCount][promiseFunctionIndex] = score.scoreUserID;

                break;
                case 11:                  
                  // console.log('Case 8: ' + score.scoreID);

                  promiseArray[displayRowCount][promiseFunctionIndex] = score.scoreInEditState;

                break;
                case 12: 
                  // console.log('Case 8: ' + score.scoreID);
                  // console.log(score.positionTeamMemberID);

                  promiseArray[displayRowCount][promiseFunctionIndex] = score.positionTeamMemberID;

                break;
                case 13: 
                  // console.log('Case 8: ' + score.scoreID);

                  promiseArray[displayRowCount][promiseFunctionIndex] = score.departmentTeamMemberID;

                break;
                case 14: 
                  // console.log('Case 8: ' + score.scoreID);

                  promiseArray[displayRowCount][promiseFunctionIndex] = score.shiftTeamMemberID;

                break;
                case 15: 
                  // console.log('Case 8: ' + score.scoreID);

                  promiseArray[displayRowCount][promiseFunctionIndex] = score.scoreStatusID;
            ...
            for (let index = 0; index <= 5; index++) {
              switch (index) {                        
                ...
                case 5: 
                  ...
                  let scoreTeamMemberID = promiseArray[promiseArrayIndex][9];
                  let scoreUserID = promiseArray[promiseArrayIndex][10];
                  let scoreInEditState = promiseArray[promiseArrayIndex][11];
                  let positionTeamMemberID = promiseArray[promiseArrayIndex][12];
                  let departmentTeamMemberID = promiseArray[promiseArrayIndex][13];
                  let shiftTeamMemberID = promiseArray[promiseArrayIndex][14];
                  let scoreStatusID = promiseArray[promiseArrayIndex][15];
